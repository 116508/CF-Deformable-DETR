...
class CocoDetection(TvCocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        if self._transforms is not None:
            img, img_T, target, target_T = self._transforms(img, img_T, target, target_T)
...
def build(image_set, args):
    ...
    # PATHS = {
    #     "train": (root / "train", root / "annotations" / f'visible_train_labels.json'),
    #     "val": (root / "test", root / "annotations" / f'visible_test_labels.json'),
    # }
    # PATHS_T = {
    #     "train": (root / "train", root / "annotations" / f'ir_train_labels.json'),
    #     "val": (root / "test", root / "annotations" / f'ir_test_labels.json'),
    # }
    # PATHS = {
    #     "train": (root / "train/visible", root / "annotations" / f'visible_train_labels.json'),
    #     "val": (root / "test/visible", root / "annotations" / f'visible_test_labels.json'),
    # }
    # PATHS_T = {
    #     "train": (root / "train/lwir", root / "annotations" / f'ir_train_labels.json'),
    #     "val": (root / "test/lwir", root / "annotations" / f'ir_test_labels.json'),
    # }
